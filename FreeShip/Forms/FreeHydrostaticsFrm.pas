...
begin
   ...
   begin
      ...
      try
         ...
         I:=2;
         while (Value<=EndDraft) or (abs(Value-EndDraft)<1e-3) do
         begin
            HydObject.Clear;
            HydObject.HeelingAngle:=0.0;
            HydObject.Trim:=Trim;
            HydObject.Draft:=Value;
            HydObject.Calculate;
            ResultsDlg.Grid.Cells[ 0,I]:=FloatToStrF(HydObject.Draft,ffFixed,7,3);
            ...
            ResultsDlg.Grid.Cells[ 7,I]:=FloatToStrF(HydObject.Data.CenterOfBuoyancy.Z,ffFixed,7,3);
            ResultsDlg.Grid.Cells[ 8,I]:=FloatToStrF(HydObject.Data.BlockCoefficient,ffFixed,7,4);
            ResultsDlg.Grid.Cells[ 9,I]:=FloatToStrF(HydObject.Data.Mainframearea,ffFixed,7,3);
            ResultsDlg.Grid.Cells[10,I]:=FloatToStrF(HydObject.Data.MainframeCoeff,ffFixed,7,4);
            ...
            ResultsDlg.Grid.Cells[14,I]:=FloatToStrF(HydObject.Data.PrismCoefficient,ffFixed,7,4);
            ...
            ResultsDlg.Grid.Cells[16,I]:=FloatToStrF(HydObject.Data.KMtransverse,ffFixed,7,3);
            ResultsDlg.Grid.Cells[17,I]:=FloatToStrF(HydObject.Data.KMlongitudinal,ffFixed,7,NumberOfDecimals(HydObject.Data.KMlongitudinal));
            inc(I);
