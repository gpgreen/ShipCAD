...
public:
	...
	HydrostaticCalc* getHydrostaticCalculation(size_t index);
	
	void loadBinary(FileBuffer& buf, QImage& img);
...
private:
    ...
    std::vector<HydrostaticCalc*> _calculations;
};
